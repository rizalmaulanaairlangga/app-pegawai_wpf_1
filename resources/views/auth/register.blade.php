...
@section('auth_title', 'Daftar Akun HRISense')
...
<form action="{{ route('register.process') }}" method="POST" class="space-y-4">
    ...
    <div>
        ...
        placeholder="Gunakan email yang terdaftar" required>
    </div>
...
<p class="mt-3">
  Sudah punya akun? <a href="{{ route('login') }}" class="font-bold text-indigo-700">Login</a>
</p>
@endsection
